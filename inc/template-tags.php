...
function twentyfifteen_entry_meta() {
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		printf( '<span class="posted-on"><span class="screen-reader-text">%1$s </span><a href="%2$s" rel="bookmark">%3$s</a>
                    <span class="byline" style="margin-left: 16px;" >
                     <span class="author vcard">
                        <span class="screen-reader-text">%4$s </span>
                        <a class="url fn n" href="%5$s">%6$s</a>
                     </span>
                   </span>
                </span>',
